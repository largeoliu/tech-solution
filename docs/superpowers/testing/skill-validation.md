...
This runbook operationalizes the layered validation strategy in `docs/superpowers/specs/2026-03-26-skill-validation-design.md` for `setup-architect` and `create-technical-solution`. Use it when validating changes to skill contracts, flow control, regression-sensitive behavior, and adversarial boundary handling.
...
- Focus: install targets, required files, forbidden legacy artifacts, and minimum `.architecture/` layout.
- Representative cases: `SA-11`, `SA-12`.

### 流程场景层

- Focus: stop/redirect behavior, prerequisite enforcement, and primary success-path branching.
- Representative cases: `SA-01`, `CTS-01`, `CTS-11`.

### 行为回归层

- Focus: fixed prompts and fixtures that verify template adherence, required semantic blocks, and non-overwrite behavior stay stable over time.
- Representative cases: `SA-03`, `CTS-04`, `CTS-09`.

### 对抗边界层

- Focus: ambiguous, partial, or risky inputs that could trigger unsafe inference, unsafe overwrite, or invalid template expansion.
- Representative cases: `SA-07`, `SA-08`, `CTS-07`, `CTS-08`.

## Phase rollout

### Phase 1

- Goal: lock the hard rules first so the suite catches unsafe continuation, unsafe inference, and silent overwrite behavior early.
- Cases: `SA-01`, `SA-02`, `SA-07`, `SA-08`, `CTS-01`, `CTS-02`, `CTS-04`, `CTS-07`, `CTS-08`.
...
- Cases: `SA-03`, `SA-04`, `SA-05`, `SA-06`, `CTS-03`, `CTS-05`, `CTS-06`, `CTS-09`.
...
- Cases: `SA-09`, `SA-10`, `SA-11`, `SA-12`, `CTS-10`, `CTS-11`, `CTS-12`.
