...
- 分阶段中间产物已按 [references/progress-transparency.md](references/progress-transparency.md) 在对话中展示：先展示 1 份结构化 `共享上下文清单`，再展示 1 份按模板槽位组织的结构化 `模板任务单`，再展示每位参与成员各 1 份按模板槽位组织的结构化 `专家产物`，以及 1 份按模板槽位组织的结构化 `协作收敛纪要`；这些中间产物默认不作为侧车文档落盘。
...
完成后，必须先按 [references/progress-transparency.md](references/progress-transparency.md) 在对话中展示这份 `共享上下文清单`。
